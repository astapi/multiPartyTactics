...
describe("buildDungeonPartyCardState", () => {
  it("returns idle state when floor is not selected", () => {
    const vm = buildDungeonPartyCardState({ selectedFloor: null, mode: "IDLE", maxUnlockedFloor: 13 });
  ...
  it("treats frontier floor as deepest explore-only", () => {
    const vm = buildDungeonPartyCardState({ selectedFloor: 13, mode: "IDLE", maxUnlockedFloor: 13 });
  ...
  it("treats other uncleared floor as target explore-only", () => {
    const vm = buildDungeonPartyCardState({ selectedFloor: 15, mode: "IDLE", maxUnlockedFloor: 13 });
  ...
  it("shows auto-running state on cleared floor when mode is AUTO", () => {
    const vm = buildDungeonPartyCardState({ selectedFloor: 8, mode: "AUTO", maxUnlockedFloor: 13 });
  ...
  it("shows explore + auto on cleared floor when mode is not AUTO", () => {
    const vm = buildDungeonPartyCardState({ selectedFloor: 8, mode: "EXPLORE", maxUnlockedFloor: 13 });
